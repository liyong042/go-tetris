...
var (
	...
	//方块随机颜色
	brickColors = []termbox.Attribute{ termbox.ColorBlack, termbox.ColorRed, termbox.ColorGreen, termbox.ColorYellow, termbox.ColorBlue, termbox.ColorMagenta, termbox.ColorCyan, termbox.ColorWhite,}
)
//地图字符对应颜色
...
func drawWindow() {
	...
	drawBackGround(backGround, 1, 0)					 		//画游戏界面
	drawBrickArray()													//画游戏地图
...
func moveDown() bool {
	...
	checkFull()
	createRandBrick()
	if !isPut( curPosX, curPosY, &curBrick ) {
		initGame()								//游戏失败
	}
	return false
}
